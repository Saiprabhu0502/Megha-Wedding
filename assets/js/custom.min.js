  ...
  AOS.init(),
    setInterval(function () {
      ...
      (n = Math.floor(
        (l =
          (o =
            Date.parse((o = new Date("05 April 2024 00:42:00 GMT+01:00"))) /
            1e3) - (e = Date.parse((e = new Date())) / 1e3)) / 86400
      )),
    ...
    setInterval(function () {
      ...
      (n = Math.floor(
        (l =
          (o =
            Date.parse((o = new Date("23 March 2024 19:50:00 GMT+01:00"))) /
            1e3) - (e = Date.parse((e = new Date())) / 1e3)) / 86400
      )),
        (t = Math.floor((l - 86400 * n) / 3600)),
        (a = Math.floor((l - 86400 * n - 3600 * t) / 60)),
    ...
    $(".tilakBtn a").click(function () {
      $(".mob-toggle").removeClass("open"),
        $(".navmenu").removeClass("open"),
        $("html, body").animate({ scrollTop: +$("#tilak").offset().top }, 1500);
    }),
    $(".haldiBtn a").click(function () {
      $(".mob-toggle").removeClass("open"),
        $(".navmenu").removeClass("open"),
        $("html, body").animate({ scrollTop: +$("#haldi").offset().top }, 1500);
    }),
